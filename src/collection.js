...
Collection.prototype.processOnMove = function (evt) {
    ...
    if (opts.follow) {
        ...
        if (dist > size) {
            ...
            nipple.el.style.top = u.generalClamp(nipple.position.y - (self.box.top + scroll.y), clampPadding, self.box.height - clampPadding) + 'px';
            nipple.el.style.left = u.generalClamp(nipple.position.x - (self.box.left + scroll.x), clampPadding, self.box.width - clampPadding) + 'px';
